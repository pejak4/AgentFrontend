...
class SearchPage extends React.PureComponent {
    ...
    componentDidMount = () => {
        ...
        //niz svih cena auta onih koji su dosli iz pocetne pretrage
        // let priceArray = [];
        // for(let i=0; i < carArray.length; i++) {
        //     if(!priceArray.includes(carArray[i].price))
        //         priceArray.push(carArray[i].price);
        // }
    ...
    selectHandler = (event, type) => {
        ...
        for(let i=0; i<brandCars.length; i++) {
            if(modelCars.includes(brandCars[i]) && fuelTypeCars.includes(brandCars[i]) && transmissionCars.includes(brandCars[i])
                && classCarCars.includes(brandCars[i]) && priceCars.includes(brandCars[i])) {
                    ...
                    <div className="containerSearch showcase-containerSearch" style={{overflowY:'scroll'}}>
                        <div className="filterDiv">
                            <FormControl className="select-brand">
                                ...
                                <FormHelperText>Filter cars by brand</FormHelperText>
                            </FormControl>
                            ...
                            <FormControl className="select-brand">
                                ...
                                <FormHelperText>Filter cars by model</FormHelperText>
                            </FormControl>
                            ...
                            <FormControl className="select-brand">
                                ...
                                <FormHelperText>Filter cars by fuel type</FormHelperText>
                            </FormControl>
                            ...
                            <FormControl className="select-brand">
                                ...
                                <FormHelperText>Filter cars by transmission</FormHelperText>
                            </FormControl>
                            ...
                            <FormControl className="select-brand">
                                ...
                                <FormHelperText>Filter cars by class car</FormHelperText>
                            </FormControl>
